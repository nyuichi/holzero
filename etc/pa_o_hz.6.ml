(* ========================================================================== *)
(* OCAML PARSER FOR CAMLP5 6.X (HOL Zero)                                     *)
(* - OCaml parser adjusted to enable backquotes in the lexer                  *)
(*                                                                            *)
(* by Mark Adams                                                              *)
(* Copyright (c) Proof Technologies Ltd, 2010-2013                            *)
(*                                                                            *)
(* Based on source code written for Camlp5 by Daniel de Rauglaudre            *)
(* Copyright (c) INRIA, 2007-2012                                             *)
(* ========================================================================== *)


(* This file is created simply by taking the Camlp5 source code file          *)
(* 'etc/pa_o.ml' (Camlp5 version 6.11) and changing 'Plexer' module prefixes  *)
(* to 'Plexer_hz'.  The changed lines end with the ML comment "HZ".           *)
...
(* #load "pa_extend.cmo";  *)                                           (* HZ *)
(* #load "q_MLast.cmo";    *)                                           (* HZ *)
#load "pa_macro.cmo";                                                   (* HZ *)
...
do {
  let odfa = Plexer_hz.dollar_for_antiquotation.val in                  (* HZ *)
  Plexer_hz.dollar_for_antiquotation.val := False;                      (* HZ *)
  Plexer_hz.utf8_lexing.val := True;                                    (* HZ *)
  Grammar.Unsafe.gram_reinit gram (Plexer_hz.gmake ());                 (* HZ *)
  Plexer_hz.dollar_for_antiquotation.val := odfa;                       (* HZ *)
...
Pcaml.add_option "-no_quot" (Arg.Set Plexer_hz.no_quotations)           (* HZ *)
